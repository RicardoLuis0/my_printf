    ...
    /*
        usage:
            ...
            %% is escape for percent
                ...
                type 'E': print number as uppercase scientific notation, ignored if non-numeric
                position: index of parameter in arglist, will not increment parameter index for non-positioned params
        example:
            printf("%03{}",99)
                :'099'
